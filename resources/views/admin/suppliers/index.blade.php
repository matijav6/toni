            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form method="GET" action="{{ url('/admin/suppliers') }}" accept-charset="UTF-8" class="navbar-form navbar-right" role="search">
                            ...
                            <table class="table table-borderless">
                                ...
                                @foreach($suppliers as $item)
                                    <tr>                                       
                                        ...
                                        <td>                                           
                                            <a href="{{ url('/admin/suppliers/' . $item->id . '/edit') }}" title="Edit Supplier"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
